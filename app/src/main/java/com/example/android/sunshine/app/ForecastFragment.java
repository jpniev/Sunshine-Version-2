...
public class ForecastFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String[] pronosticoArray = {
                "Hoy - Soleado - 21/32", "Mañana - Nublado - 18/30", "Domingo - Lluvioso - 14/28",
...
//            }
        ...
        protected String[] doInBackground(String... params) {
            ...
            try {
                ...
                //URL url = new URL("http://api.openweathermap.org/data/2.5/forecast/daily?id=3435910&lang=sp&cnt=7&appid=44db6a862fba0b067b1930da0d769e98");
